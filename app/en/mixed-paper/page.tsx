...
export default function Page() {
  return (
      ...
      <BreadcrumbsLd items={[{name:"Home",url:"https://tohiretrading.com/"},{name:"Materials",url:"https://tohiretrading.com/#materials"},{name:"Mixed Papers and Boards (1.02)",url:"https://tohiretrading.com/en/mixed-paper"}]} />
